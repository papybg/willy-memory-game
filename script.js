...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function startGame() {
        ...
        // НОВО: Смяна на фона при стартиране на играта
        document.body.classList.remove('start-bg'); // Премахваме стартовия фон
        if (selectedTheme === 'превозни_средства') {
            document.body.classList.add('vehicles-bg');
        } else if (selectedTheme === 'animals') {
            document.body.classList.add('animals-bg');
        } else if (selectedTheme === 'flowers') {
            document.body.classList.add('flowers-bg');
        }
    ...
    function chooseHandler(e) {
        ...
        if (chosen === hidden) {
            ...
            bravoAudio.play(); // Пускаме аудио за успех
            ...
            opitaiPakAudio.play(); // Пускаме аудио за грешка
        }
    }
    ...
    function resetGameState() {
        ...
        // НОВО: Връщане на стартовия фон при нова игра
        document.body.classList.remove('vehicles-bg', 'animals-bg', 'flowers-bg'); // Премахваме всички игрови фонове
        document.body.classList.add('start-bg'); // Добавяме стартовия фон
    }
    ...
    reloadBtn.addEventListener('click', () => {
        ...
        resetGameState(); // resetGameState вече ще се погрижи за фона
    });
    ...
    // НОВО: Задаваме стартовия фон при първоначално зареждане
